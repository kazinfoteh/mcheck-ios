...
Pod::Spec.new do |s|
  s.name             = 'MCheck'
  s.version          = '0.1.0'
  s.summary          = 'A short description of MCheck.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Kurdakrx/MCheck'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Kurdakrx' => 'shopanov.yelnar@gmail.com' }
  s.source           = { :git => 'https://github.com/Kurdakrx/MCheck.git', :tag => s.version.to_s }
